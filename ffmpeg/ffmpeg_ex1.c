  ...
  printf("path = %s\n", path);
    ...
    *size = 0;
    ...
    while (av_read_frame(format, &packet) >= 0) {
      ...
      // This function is deprecated.... and doesnt seem to work
...
{
  const char *path = "/c/aaa/YesterdayWasMonday.mp3";
...
//    logging("ERROR could not allocate memory for Format Context");
  ...
  printf("format->bit_rate=%ld\n", format->bit_rate);
  printf("About to call stream_info\n");
